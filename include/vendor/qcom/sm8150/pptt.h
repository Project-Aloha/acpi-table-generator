...
#define CLUSTER_PRIVATE_RESOURCES_COUNT 0      // Not needed
...
PPTT_START{
    ...
    PPTT_DECLARE_PROCESSOR_HIERARCHY_PHYSICAL_CPU(
        0, 0, PPTT_REFERENCE_SYSTEM, PPTT_REFERENCE_CACHE(2),
        PPTT_REFERENCE_CACHE(3)),
    PPTT_DECLARE_PROCESSOR_HIERARCHY_PHYSICAL_CPU(
        1, 1, PPTT_REFERENCE_SYSTEM, PPTT_REFERENCE_CACHE(2),
        PPTT_REFERENCE_CACHE(3)),
    PPTT_DECLARE_PROCESSOR_HIERARCHY_PHYSICAL_CPU(
        2, 2, PPTT_REFERENCE_SYSTEM, PPTT_REFERENCE_CACHE(2),
        PPTT_REFERENCE_CACHE(3)),
    PPTT_DECLARE_PROCESSOR_HIERARCHY_PHYSICAL_CPU(
        3, 3, PPTT_REFERENCE_SYSTEM, PPTT_REFERENCE_CACHE(2),
        PPTT_REFERENCE_CACHE(3)),
    ...
    //  - private resources: L1I, L1D, L2
    PPTT_DECLARE_PROCESSOR_HIERARCHY_PHYSICAL_CPU(
        4, 4, PPTT_REFERENCE_SYSTEM, PPTT_REFERENCE_CACHE(2),
        PPTT_REFERENCE_CACHE(3)),
    PPTT_DECLARE_PROCESSOR_HIERARCHY_PHYSICAL_CPU(
        5, 5, PPTT_REFERENCE_SYSTEM, PPTT_REFERENCE_CACHE(2),
        PPTT_REFERENCE_CACHE(3)),
    PPTT_DECLARE_PROCESSOR_HIERARCHY_PHYSICAL_CPU(
        6, 6, PPTT_REFERENCE_SYSTEM, PPTT_REFERENCE_CACHE(2),
        PPTT_REFERENCE_CACHE(3)),
    PPTT_DECLARE_PROCESSOR_HIERARCHY_PHYSICAL_CPU(
        7, 7, PPTT_REFERENCE_SYSTEM, PPTT_REFERENCE_CACHE(2),
        PPTT_REFERENCE_CACHE(3)),
} PPTT_END
